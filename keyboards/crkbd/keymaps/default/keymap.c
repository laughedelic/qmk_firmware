...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LALT_T(KC_TILD),KC_Z,    KC_X,    KC_M,    KC_C,    KC_V,                         KC_K,   KC_L,    KC_COMM, KC_DOT,  KC_SLSH, RCMD_T(KC_QUOT),
                                    KC_LCMD,   LOWER, KC_BSPC,         SFT_T(KC_SPC),  RAISE,  KC_RALT
  ),

  [_LOWER] = LAYOUT( \
       KC_ESC, KC_EXLM,   KC_AT, KC_HASH,  KC_DLR, KC_PERC,                      KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC,
      KC_LCTL,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,  KC_GRV,
      KC_LSFT,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,                      KC_UNDS,  KC_EQL, KC_LBRC, KC_RBRC, KC_BSLS, KC_TILD,
                                    KC_LCMD,   LOWER, KC_BSPC,         SFT_T(KC_SPC),  RAISE,  KC_RALT
  ),
